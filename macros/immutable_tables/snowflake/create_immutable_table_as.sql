{% macro create_immutable_table_as(relation, tablecreate_statement_type, is_transient, data_retention_in_days, max_data_extension_in_days, enable_change_tracking, sql) -%}
...
{%- endif -%}    
{%- endif -%}
    enable_change_tracking = {{ enable_change_tracking | upper }}
as
    {{ sql }}
;
